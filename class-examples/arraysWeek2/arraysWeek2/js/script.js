...
//3B: add (push an object into the array starting from 0)
//mousePositions.push(mouseX);

//4:: add an obj: storing two properties as one vairable
...
//for 7 :: slice = array 0-1-2-3 are left in the sliced array
// if (key == "w") {
